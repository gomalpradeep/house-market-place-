...
function EditListing() {
  ...
  const [formData, setFormData] = useState({
    ...
    const params = useParams()
        //Redirect id listing if not user's

    useEffect(()=>{
        if(listing && listing.userRef !== auth.currentUser.uid){
            toast("You cannot edit that listing")
            navigate('/')
        }
    })
    ...
    const onSubmit =async (e) =>{
      e.preventDefault()
      console.log(geoLocationEnabled,formData  )

      setLoading(true)

      if(discountedPrice >= regularPrice){
        setLoading(false)
        toast('Discounted price needs to be less than regular price')
        return 
      }
    ...
    <div className='profile'>
      ...
      <main>
        ...
        <label className='formLabel'>Address</label> 
          <textarea  className='formInputAddress' type='text'
